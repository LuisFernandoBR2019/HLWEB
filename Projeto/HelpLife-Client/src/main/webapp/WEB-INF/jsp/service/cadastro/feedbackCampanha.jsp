...
<c:if test="${isHemocentro eq true}">
	<meta http-equiv="refresh"
		content="5; URL='http://localhost:9005/helplife/service/listar/listarCampanhaHemocentro'" />
</c:if>
<c:if test="${isHemocentro eq false}">
	<meta http-equiv="refresh"
		content="5; URL='http://localhost:9005/helplife/service/listar/usuario/listarCampanhaUsuario'" />
</c:if>
				...
				<ul class="nav navbar-nav ">
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a
								href="http://localhost:9005/helplife/service/listar/listarCampanha">Listar
									campanhas</a></li>
							<li><a
								href="http://localhost:9005/helplife/service/listar/listarCampanhaHemocentro">Minhas
									campanhas</a></li>
							<li><a
								href="http://localhost:9005/helplife/service/cadastro/cadastroCampanhaHemocentro">Criar
									campanha</a></li>
						</ul></li>
				</ul>
			...
			<div class="container">
				<div class="row justify-content-center">
					...
					<div class="col-6" align="center">
						...
						<h2>
							<a
								href="http://localhost:9005/helplife/service/listar/listarCampanhaHemocentro"><strong>aqui!</strong></a>
						</h2>
		...
		<div class="container">
			<div class="row justify-content-center">
				...
				<div class="col-6" align="center">
					...
					<h2>
						<a
							href="http://localhost:9005/helplife/service/listar/usuario/listarCampanhaUsuario"><strong>aqui!</strong></a>
					</h2>
